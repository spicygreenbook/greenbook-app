									...
									<View style={styles.volunteerDetailItem}>
										{!!isWeb ? (
											<Text style={styles.text_body2}>
												Started on:
												{" " + new Date(data._date_started.value).toLocaleDateString()}
											</Text>
										) : (
											<Text style={styles.text_body2}>
												Started on:
												{" " + Date(new Date(data._date_started.value).toLocaleDateString()).slice(4, 15)}
											</Text>
										)}
									</View>
								)}
												...
												<Link href={link.link}>
													<Text style={styles.text_body2}>
														...
														{link && link.link_title && link.link_title.toLowerCase().indexOf("linkedin") > -1 && (
															<FontAwesome name="linkedin" size={16} color="#B56230" style={{ marginRight: 10 }} />
														)}
														{link && link.link_title && link.link_title.toLowerCase().indexOf("twitter") > -1 && (
															<FontAwesome name="twitter" size={16} color="#B56230" style={{ marginRight: 10 }} />
														)}
														{link && link.link_title && link.link_title.toLowerCase().indexOf("facebook") > -1 && (
															<FontAwesome name="facebook" size={16} color="#B56230" style={{ marginRight: 10 }} />
														)}
