			...
			<View
				...
				<View style={{ flex: 1, flexDirection: 'row' }}>
					<Image
						...
						cdn
						source={{ uri: listing.primary_image.url + '&w=400' }}
					/>
				</View>
				<View style={{ flex: 2, paddingLeft: 20 }}>
					...
					<Text
						style={[
							styles.text_body2,
							{ fontSize: 13, paddingTop: 10, paddingBottom: 20 },
						]}>
						{listing.description}
					</Text>
					<View
					...
					/>
					{!!listing.cuisines && !!listing.cuisines.length && (
						<View
							style={{
								flexDirection: 'row',
								alignItems: 'center',
					...
					{!!listing.phone_number && (
						<Text style={[styles.text_body3, { fontSize: 16, paddingTop: 20 }]}>
							{listing.phone_number}
						</Text>
					)}
					{!!listing.address && (
						<Text
							style={[
								styles.text_body3,
								{ fontSize: 16, paddingTop: 10, paddingBottom: 20 },
							]}>
							{listing.address}
						</Text>
					)}
