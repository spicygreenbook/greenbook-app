	...
	return (
		<View nativeID='footer' style={styles.footer}>
			<View
				...
				<View
					style={[
						dimensions.width < 980 ? {} : { flexDirection: 'row' },
						{ flex: 1, width: 1024, maxWidth: '100%' },
					]}>
					{/** Subscribe Form */}
					{view === '/' ? null : (
						<View
				...
				<View
					...
					{LINKS.map(({ url, label }) => (
						<Link
							...
							style={{ display: 'block' }}
							href={url}
							target={url.includes('http') ? '__blank' : null}>
							<Text
								style={[
									styles.text_footer,
				...
				{isWeb && (
					<View
						...
						<View
							...
							<a
								href='https://vercel.com/?utm_source=spicygreenbook'
