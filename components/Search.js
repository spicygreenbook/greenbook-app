...
import {
  addRootClickHandler,
  removeRootClickHandler
} from "../utils/rootClickHandler";
...
const Search = ({
  ...
  const [query, setQuery] = useState(
    (searchConfig.q || "").replace(/\+/g, " ")
  );
  const [near, setNear] = useState(
    (staticCityState || searchConfig.near || "").replace(/\+/g, " ")
  );
      ...
      >
        <View
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            flex: small || mode !== "results" ? 1 : tablet ? 0.75 : 0.7,
          ...
          >
            ...
            >
              ...
              <TextInput
                ...
                style={[styles.text_body, { height: 30, fontSize: 16 }]}
                placeholder={
                  small ? "Near" : "Address, city, zip, state or neighborhood"
                }
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text
                  style={[styles.text_input, { flex: 1, color: Theme.green }]}
                >
                  Current Location
                </Text>
              </View>
