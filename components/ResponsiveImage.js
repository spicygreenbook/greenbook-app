  ...
  if (isWeb) {
    ...
    return (
      <NextImage
        ...
        height={
          props.style.height || props.style.width * props.style.aspectRatio
        }
  ...
  return (
    <View
      onLayout={event => {
        ...
        if (
          ...
          props.source &&
          props.source.uri &&
          props.source.uri.indexOf(
            "prismic-io.s3.amazonaws.com/spicygreenbook"
          ) > -1
        ) {
          setURI(
            props.source.uri +
              "?w=" +
              responsiveImageWidthCDN({ containerWidth: w })
          );
        }
      }}
    ...
    >
      {isWeb ? (
        ...
        <Image {...props} {...set} style={{ width: width, height: height }} />
      )}
      {props.layerColor && (
        <View
          style={{
