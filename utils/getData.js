...
const isLocalWeb = () => typeof window !== "undefined" && window.location && window.location.host.indexOf("localhost") > -1;
...
export async function getData2(config) {
	...
	let cacheKey = Object.keys(config)
		.filter((key) => {
...
export async function getData(config) {
	...
	if (config.type === "updates") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.updates.date%20desc%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "listing") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.listing.home_page_order%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "staff") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.staff.order%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "press") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.press.date%20desc%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "volunteers") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.volunteers.date_started%20desc%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "faq") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.faq.order%20desc%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "testimonial") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${config.type}%22)%5D%5D${
			config.limit ? "&pageSize=" + config.limit : ""
		}`;
	} else if (config.type === "roles") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.roles.order%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "sponsors") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.sponsors.order%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else if (config.type === "social_media_graphics") {
		url = `https://spicygreenbook.cdn.prismic.io/api/v1/documents/search?ref=${master_ref}&q=%5B%5Bat(document.type%2C+%22${
			config.type
		}%22)%5D%5D&orderings=%5Bmy.social_media_graphics.updated%5D${config.limit ? "&pageSize=" + config.limit : ""}`;
	} else {
