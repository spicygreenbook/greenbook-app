...
export async function getStaticProps(context) {
    let content = await getContent({type: 'content', uid: 'faq', ref_id: context.preview || ''});
    let faqs = await getData({type: 'faq'})

    return {
        props: {content: content && content.content || {}, faqs: faqs, url: '/faq'}
    };
}
