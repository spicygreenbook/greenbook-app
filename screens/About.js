  ...
  return (
		<View>
			...
			<View
				style={[
					styles.section,
					{ fontSize: 24, paddingTop: 40, paddingBottom: 40 },
				]}>
				<View style={styles.content}>
					<View
						style={
							...
							<View
								...
								<View
									...
									<Text style={styles.text_body}>
										We are Spicy Green Book – a virtual directory for
										Black-owned food and beverage businesses throughout the US
										and Canada.
									</Text>
								</View>
							</View>
						...
						<View style={{ flex: 1 }}>
							<View
								...
								<View
									...
									<Text style={styles.text_body}>
										Our mission is to empower Black-owned food and drink
										businesses to compete and thrive in the marketplace. We
										connect customers with these businesses, making it easy for
										them to participate in what we like to call the ‘Intentional
										Economy’. Our work enables people to enjoy fantastic food
										while using their buying power to create a more equitable
										society.{'\n'}
										{'\n'}
										By providing professional creative services free of charge
										through a legion of passionate volunteers, we get these
										businesses online and in front of customers. In doing so, we
										are building substantive relationships and social trust
										within communities and creating a more equitable society.
									</Text>
								</View>
							</View>
						</View>
						...
						<View style={{ flex: 1 }}>
							<View
								...
								<View
									...
									<Text style={styles.text_body}>
										Spicy Green Book provides a wide variety of professional
										services to Black-owned food and drink business owners.
										These include online marketing and advertising, content
										creation, photography and videography, business development
										education, and more.{'\n'}
										{'\n'}
										We do this by getting to know these business owners,
										understanding their most pressing needs, and fulfilling
										those needs by pairing them with qualified professional
										volunteers. Our growing group of volunteers welcomes
										everyone who wants to spark positive change.
									</Text>
								</View>
							</View>
						</View>
					...
					<View
						...
						<View
							...
							<Text
								...
								Ensure marginalized people will receive the representation they
								deserve.
							</Text>
						</View>
					</View>
				...
				<View
					...
					<View
						...
						<Text
							...
							We help Black-owned food and drink business owners tell their
							story, sowing the seeds of trust, support, and positive change
				...
				<View style={styles.content}>
					<View
						...
						<View
							...
							<Text style={styles.text_body}>
								From 1936 to 1964, during the Jim Crow era, Black men and women
								were under the persistent threat of violence in the form of
								lynchings and other hate crimes. To help them escape this
								violence, Victor Green created The Negro Motorist Green Book.
								Our name is an homage to his original creation, a guide that led
								Black travelers to a community of businesses throughout the US
								where they could eat, sleep, and be safe. Spicy Green Book
								builds on Green’s idea, empowering everyone to create and
								participate in a fairer, safer, more just society.
							</Text>
						</View>
						<View
							style={
				...
				<View style={styles.content}>
					<View
						...
						<View
							...
							<Text style={styles.text_body}>
								At Spicy Green Book we want to share the stories behind the
								businesses. We want local communities – and the world – to hear
								the stories of the people and cultures that inspired these
								businesses to open their doors.{'\n'}
								{'\n'}
								We believe that telling these stories will enable people of
								varying backgrounds to get to know the people, cultures, hard
								work, and love that brought these Black-owned businesses to
								fruition. Through this storytelling, we hope to humanize the
								Black community and change the taught perspectives which far too
								often lead to unnecessary violence and systematic oppression.
								{'\n'}
								{'\n'}
								As people’s understanding changes, we believe more people will
								see the value in Black lives and livelihoods and, as a result,
								fewer people will engage in acts of violence and hatred toward
								the Black community. We want to start a ripple effect of
								positive change throughout local communities and across the
								country.
							</Text>
						</View>
					</View>
				...
				<View style={styles.content}>
					<View
						...
						<View
							...
							<Text style={styles.text_body}>
								Spicy Green Book is a space that enables Black-owned businesses
								to amplify their voices. We work closely with each business to
								make sure that our work fits with the owners’ vision and
								mission. All work is approved by the owner before publication.
								{'\n'}
								{'\n'}
