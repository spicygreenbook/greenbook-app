...
const Testimonial = ({ testimonials }) => {
  ...
  const deviceWidth = isWeb
    ? dimensions.width > 1083
      ? 1024
      : dimensions.width - 60
    : dimensions.width - 40;
  ...
  return (
    <View
      style={[
        styles.section,
        { backgroundColor: Theme.green_bg, paddingBottom: 40, marginBottom: 40 }
      ]}
    >
      <View style={styles.content}>
        ...
        >
          <Text
            style={[
              styles.text_header5,
              { color: "#000", fontSize: isWeb ? 28 : 22 }
            ]}
          >
            TESTIMONIALS
          </Text>
              ...
              >
                <ImageBackground
                  style={
                    isWeb
                      ? {
                          width: dimensions.width < 900 ? 280 : 380,
                          height: dimensions.width < 900 ? 257 : 347,
                          marginLeft: 40
                        }
                  ...
                  <Image
                    ...
                    source={
                      isWeb
                        ...
                        : require("../../public/images/testimonial.png")
                    }
                  />
                </ImageBackground>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {!!item.link && (
                        <Link href={item.link} contain>
                          <View
                            style={[
                              styles.button_green,
                              { borderColor: "#fff", height: 40 }
                            ]}
                          >
                            <Text
                              style={[
        ...
        <View
          style={{
            position: "absolute",
            top: isWeb ? (dimensions.width < 900 ? "35%" : "50%") : "45%",
            width: "100%"
          }}
        >
          <View
              ...
              <TouchableOpacity
                onPress={(e) => {
                  scrollToIndexListing(
                    { animated: true, index: currentIndexListing - 1 },
                    data.length
                  );
                }}
              >
        ...
        <View
          style={{
            alignItems: "flex-end",
            marginRight: isWeb ? dimensions.width * -0.05 : 0
          }}
        >
          <Link href={"/testimonials"} contain>
            <View>
              <Text
                style={[
                  styles.text_link,
                  {
                    color: "#fff",
                    fontSize: isWeb ? (dimensions.width > 900 ? 20 : 16) : 16,
                    fontWeight: "bold"
                  }
                ]}
              >
                {"See Them All On Our Testimonial Page"}
