		...
		<View style={[styles.section, { backgroundColor: Theme.green_bg, paddingBottom: 40, marginBottom: 40 }]}>
			<View style={[styles.content]}>
				{loadingTestimonial ? (
					...
					<Alert severity="error" message={errorTestimonials} />
				) : (
					<>
...
const styles = StyleSheet.create(getStyles("section, text_body3, content, text_header5, button_green, button_green_text, text_quote"));
