        ...
        <React.Fragment>
            <ScrollView ref={scrollViewRef}>
                    ...
                    <View>
                        ...
                        <View onLayout={event => setLayout(event.nativeEvent.layout)} ref={sponsorBenefit} style={[styles.section, { paddingTop: 20, paddingBottom: 20 }]}>
                            <View style={styles.content}>
                        ...
                        <View ref={ourSponsors} style={styles.section}>
                            <View style={styles.content}>
                                ...
                                <View style={dimensions.width < 830 ? moreStyles.ourSponsorsBtnSmall : moreStyles.ourSponsorsBtnLarge}>
                                    ...
                                    <TouchableOpacity style={isWeb && dimensions.width > 830 ? [styles.button_green, { marginLeft: 10, flexBasis: '30%' }] : isWeb && dimensions.width < 830 ? [styles.button_green, moreStyles.becomeSponsorWebLarge] : [styles.button_green, moreStyles.becomeSponsorWebSmall]}><NextLink href="mailto:d.batson@spicygreenbook.org"><Text style={dimensions.width < 830 ? [styles.button_white_text, { marginLeft: 50 }] : [styles.button_white_text, { paddingLeft: 20 }]}>BECOME A SPONSOR</Text></NextLink></TouchableOpacity>
                                </View>
...
const moreStyles = StyleSheet.create({
    ...
    oppGapContainerLarge: { backgroundColor: Theme.green_bg, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', paddingTop: 40, paddingBottom: 40 },
