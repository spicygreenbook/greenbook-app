...
function Page(props) {
    ...
    const [benefitLayout, setBenefitLayout] = useState(2016.6666259765625)
            ...
            <TouchableOpacity activeOpacity={1} style={{ cursor: 'default' }} onPress={e => handleRootClick(e)}>
                <View>
                    <View style={isWeb && dimensions.width > 800 ? {
                        ...
                        justifyContent: 'space-around', paddingTop: 25, position: 'fixed', top: 0, left: 0, right: 0, zIndex: 10
                    } : { backgroundColor: Theme.green_bg, paddingTop: 30, justifyContent: 'center', alignItems: 'center', paddingBottom: 20 }}>
                        {
                            isWeb ? headerLinks.map((header, index) => (
                                <View style={dimensions.width < 800 && header.title === 'Why Sponsor?' ? { marginTop: 120 } : { marginTop: 50 }} key={index}>
                                    <View style={dimensions.width < 800 ? { display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap' } : header.title !== 'BECOME A SPONSOR' ? { marginTop: 40 } : { backgroundColor: 'black', padding: 10, marginTop: 40 }} >
                                        {
                                ...
                                headerLinks.map((header, index) => (
                                    <View key={index}>
                                        <View style={dimensions.width < 800 && header.title === 'BECOME A SPONSOR' ? moreStyles.btnHeader2Container : { marginTop: 40, alignItems: 'center' }} >
                                            {
                                                header.title === 'BECOME A SPONSOR' ? <NextLink href="mailto:d.batson@spicygreenbook.org"><Text style={[moreStyles.btnHeader2, { color: 'white' }]}>BECOME A SPONSOR</Text></NextLink>
                                                    ...
                                                    <Button onPress={() => {
                                                        // console.log(scroll)
                                                        scroll.current.scrollTo({ x: 0, y: benefitLayout, animated: true })
                                                    }} color="white" style={dimensions.width < 800 && header.title === 'BECOME A SPONSOR' ? moreStyles.btnHeader2 : { fontFamily: "ApercuMedium", fontWeight: 'bold' }} title={header.title} />
                                            }
                    ...
                    <View ref={whySponsor} style={isWeb && dimensions.width > 800 ? [styles.section, moreStyles.whySponsorSection] : [styles.section, { fontSize: 24, paddingTop: 40 }]}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? {} : moreStyles.whySponsorContainer}>
                                <View style={{ flex: 1 }}>
                                    <View style={dimensions.width < 800 ? {} : moreStyles.whySponsorDiv}>
                                        <View style={dimensions.width < 800 ? { paddingTop: 40, alignItems: 'center' } : { flex: 2, paddingLeft: 20 }}>
                    ...
                    <View style={[styles.section, { paddingTop: 10, paddingBottom: 20 }]}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? moreStyles.oppGapContainerSmall : moreStyles.oppGapContainerLarge}>
                                <View style={dimensions.width < 800 ? {} : { flex: 2, paddingRight: 40 }}>
                                    <ResponsiveImage
                                ...
                                <View style={dimensions.width < 800 ? { paddingTop: 40 } : { flex: 2, paddingRight: 20 }}>

                                    <Text style={dimensions.width < 800 ? [styles.text_body, moreStyles.oppGapSmall] : [styles.text_body, moreStyles.oppGapLarge]}>
                                    ...
                                    <Text style={dimensions.width < 800 ? [styles.text_body, moreStyles.oppGapSmall] : [styles.text_body, moreStyles.oppGapLarge, { paddingTop: 10 }]}>
                    ...
                    <View style={styles.section}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? { alignItems: 'center', marginTop: 40 } : moreStyles.quoteLarge}>
                                ...
                                <View style={dimensions.width < 800 ? { paddingTop: 40 } : { flex: 14, paddingLeft: 20 }}>
                    ...
                    <View onLayout={event => {
                        ...
                        setBenefitLayout(event.nativeEvent.layout.y)
                    }}
                        ref={sponsorBenefit} style={[styles.section, { paddingTop: 20, paddingBottom: 20 }]}>
                        <View style={styles.content}>
                            <View style={{ alignSelf: 'flex-start' }}>
                                <Text accessibilityRole="header" aria-level="3" style={[styles.text_header3, dimensions.width < 800 ? { marginBottom: 20, marginLeft: 50 } : { marginBottom: 20 }]}>SPONSORSHIP BENEFITS</Text>
                            </View>
                            <View style={dimensions.width < 800 ? {} : moreStyles.imgTxtContainer2}>

                                <View style={dimensions.width < 800 ? moreStyles.broadVisContainerSmall : moreStyles.broadVisContainerLarge}>
                                    <Text style={moreStyles.listTitle}>
                                        Broaden your visibility:
                                </Text>

                                    <View style={moreStyles.textList}>
                                        <FontAwesome name="check" size={25} style={moreStyles.checkMark} />
                                ...
                                <View style={dimensions.width < 800 ? { paddingTop: 40 } : { flex: 1.1 }}>
                                    <ResponsiveImage
                    ...
                    <View style={[styles.section, { paddingTop: 20, paddingBottom: 20 }]}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? {} : moreStyles.imgTxtContainer2}>
                                ...
                                <View style={dimensions.width < 800 ? { paddingTop: 40 } : { flex: 1.2 }}>
                                    <ResponsiveImage
                                        style={{ width: 700, resizeMode: 'contain', aspectRatio: 1.2 }}
                                        alt="plate of crab"
                                ...
                                <View style={dimensions.width < 800 ? moreStyles.buildRepContainerSmall : moreStyles.buildRepContainerLarge}>
                                    <Text style={moreStyles.listTitle}>
                    ...
                    <View ref={sponsorLevel} id="sponsor_levels" style={styles.section}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? { alignItems: 'center', paddingBottom: 30 } : { alignSelf: 'flex-start', paddingBottom: 30 }}>
                            ...
                            <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignContent: 'center', justifyContent: 'space-around' }}>
                                {sponsorLevels && sponsorLevels.map(level => (
                                    <View style={{ paddingBottom: 40 }} key={level.title}>
                                        ...
                                        <View style={dimensions.width < 800 ? [moreStyles.levels, { justifyContent: 'flex-start', alignItems: 'center' }] : [moreStyles.levels, { justifyContent: 'center', flexDirection: 'row' }]}>
                                            <Text style={dimensions.width < 800 ? [styles.button_white_text, moreStyles.amount, { lineHeight: 65, marginTop: 60 }] : [styles.button_white_text, moreStyles.amount]}><FontAwesome name="dollar" size={60} color="white" />{level.amount}</Text>
                                        </View>

                                        <Text style={dimensions.width < 800 ? [styles.text_header4, moreStyles.levelTitleSmall] : [styles.text_header4, moreStyles.levelTitleLarge]}>{level.title}</Text>
                                    </View>
                                ))}
                            </View>
                        </View>
                    ...
                    <View ref={ourSponsors} style={styles.section}>
                        <View style={styles.content}>
                            <View style={dimensions.width < 800 ? { alignItems: 'center', paddingBottom: 30 } : { alignSelf: 'flex-start', paddingBottom: 30 }}>
                                ...
                                <Text style={dimensions.width < 800 ? [styles.text_body, { marginTop: 20 }] : styles.text_body}>To express your interest in sponsorship, please email us: <NextLink href="mailto:d.batson@spicygreenbook.org"><Text style={{ color: '#246e43' }}>d.batson@spicygreenbook.org</Text></NextLink></Text>
                            </View>
                            <View style={dimensions.width < 800 ? moreStyles.ourSponsorsBtnSmall : moreStyles.ourSponsorsBtnLarge}>
                                <TouchableOpacity style={[styles.button_green, moreStyles.sponsorPacketBtn]}><Text style={moreStyles.sponsorPacketBtnText}>DOWNLOAD SPONSORSHIP PACKET</Text></TouchableOpacity>
                                <TouchableOpacity style={isWeb && dimensions.width > 800 ? [styles.button_green, { marginLeft: 10, flexBasis: '30%' }] : isWeb && dimensions.width < 800 ? [styles.button_green, moreStyles.becomeSponsorWebLarge] : [styles.button_green, moreStyles.becomeSponsorWebSmall]}><NextLink href="mailto:d.batson@spicygreenbook.org"><Text style={dimensions.width < 800 ? [styles.button_white_text, { marginLeft: 50 }] : [styles.button_white_text, { paddingLeft: 20 }]}>BECOME A SPONSOR</Text></NextLink></TouchableOpacity>
                            </View>
                    ...
                    <View style={styles.section}>
                        <View style={styles.content, moreStyles.sponsorLogoContent}>
                            ...
                            <View style={moreStyles.sponsorLogos}>
                                ...
                                <View style={{ flexBasis: '20%' }}>
                                    <ResponsiveImage
                                        style={{ width: 250, resizeMode: 'contain', aspectRatio: .5 }}
                                        alt="sponsor"
...
const moreStyles = StyleSheet.create({
    levels: { backgroundColor: 'black', borderRadius: 100, height: 180, width: 180, display: 'flex' },
    amount: { fontWeight: 'bold', fontSize: 60, marginTop: 80 },
    sponsorLogos: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', width: '100%', flexWrap: 'wrap' },
    sponsorLogoContent: { display: 'flex', flexWrap: 'wrap', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' },
    ...
    broadVisContainerLarge: { flex: 1, alignSelf: 'stretch', backgroundColor: Theme.green_bg, paddingLeft: 60, paddingRight: 60, paddingTop: 20, paddingBottom: 20 },
    checkedText: { fontSize: 24, alignSelf: 'flex-end', color: '#ffffff', flex: 1, lineHeight: 35 },
    quoteLarge: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', alignItems: 'center' },
    oppGapSmall: { color: 'white', paddingTop: 10, fontWeight: 'bold', fontSize: 20, lineHeight: 24 },
    oppGapLarge: { color: 'white', fontWeight: 'bold', fontSize: 22, lineHeight: 35 },
    oppGapContainerSmall: { backgroundColor: Theme.green_bg, padding: 10, paddingBottom: 40 },
    oppGapContainerLarge: { backgroundColor: Theme.green_bg, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', paddingTop: 20, paddingBottom: 20 },
    whySponsorDiv: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center' },
    whySponsorSection: { fontSize: 24, paddingTop: 40, marginTop: 200 },
    whySponsorContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingRight: 50 },
    btnHeader2: { fontFamily: "ApercuMedium", padding: 5, fontWeight: 'bold' },
    btnHeader2Container: { marginTop: 30, backgroundColor: 'black', padding: 10, width: 210, alignItems: 'center', marginHorizontal: 90 },
    webHeaderSmall: { fontSize: 24, lineHeight: 1, fontFamily: "ApercuMedium", color: 'white', fontWeight: 'bold', marginTop: 5 },
    webHeaderLarge: { fontFamily: "ApercuMedium", fontSize: 18, lineHeight: 16, color: 'white', fontWeight: 'bold' },
    webHeader2Small: { fontSize: 24, lineHeight: 1, fontFamily: "ApercuMedium", backgroundColor: 'black', padding: 10, color: 'white', fontWeight: 'bold', marginTop: 5 },
    webHeader2Large: { backgroundColor: 'black', fontFamily: "ApercuMedium", fontSize: 18, lineHeight: 16, color: 'white', fontWeight: 'bold' },
    levelTitleSmall: { alignSelf: 'center', marginTop: 15, fontSize: 30, lineHeight: 30 },
    levelTitleLarge: { alignSelf: 'center', marginTop: 15, fontSize: 30 },
    becomeSponsorWebLarge: { alignSelf: 'center', width: 315, marginRight: 10 },
    becomeSponsorWebSmall: { marginLeft: 12, marginRight: 20, alignSelf: 'stretch' },
    ourSponsorsBtnSmall: { justifyContent: 'center', alignItems: 'center', alignContent: 'center' },
    ourSponsorsBtnLarge: { flexDirection: 'row', justifyContent: 'center', alignContent: 'center' },
    sponsorPacketBtn: { backgroundColor: 'white', marginRight: 10, marginBottom: 10 },
    sponsorPacketBtnText: { color: '#246e43', fontSize: 16, lineHeight: 15, fontFamily: "ApercuMedium" }
})
