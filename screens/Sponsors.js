...
import { sponsorLevels } from "../utils";
import {
  StyleSheet,
  Platform,
  SafeAreaView,
        ...
        <View ref={topPage}>
          ...
          <View ref={sponsorLevel} id="sponsor_levels" style={styles.section}>
            <View style={styles.content}>
              ...
              >
                <FlatList
                  key={"list-cols-" + sponsorCols}
                  numColumns={sponsorCols}
                        ...
                        >
                          ...
                          >
                            ...
                            >
							  ...
							  <View style={{padding: dimensions.width < 600 ? 20 : 60}}>
                              <View
                                style={
                                  dimensions.width < 800
                                    ? { alignItems: "center", marginTop: 40 }
                                ...
                                >
                                  <ResponsiveImage
                                    ...
                                    source={
                                      isWeb
                                        ? {
                                            uri: `/images/sponsors/${item.image}.png`,
                                          }
                                        : require("../public/images/danilo.png")
                                    }
                                  />
                ...
                <View style={moreStyles.sponsorLogos}>
                  <View style={{ flexBasis: "30%", padding: 20 }}>
                    <ResponsiveImage
                      ...
                      source={
                        isWeb
                          ? { uri: "/images/sponsors/kinecta.webp" }
                          : require("../public/images/sponsors/kinecta.webp")
                      }
                    />
                  </View>
                  <View style={{ flexBasis: "30%", padding: 20 }}>
                    <ResponsiveImage
                      ...
                      source={
                        isWeb
                          ? { uri: "/images/sponsors/mongoose.png" }
                          : require("../public/images/sponsors/mongoose.png")
                      }
                    />
                  </View>
                  <View style={{ flexBasis: "30%", padding: 20 }}>
                    <ResponsiveImage
                      ...
                      source={
                        isWeb
                          ? { uri: "/images/sponsors/yahoo.webp" }
                          : require("../public/images/sponsors/yahoo.webp")
                      }
                    />
                  </View>
                </View>
                ...
                {/* <TouchableOpacity
									style={
										isWeb && dimensions.width > 830
											...
											: [styles.button_white, moreStyles.sponsorPacketBtn]
									}>
            ...
            <View style={(styles.content, moreStyles.sponsorLogoContent)}>
              ...
              >
                <Text
                  ...
                  style={[styles.text_header3, { marginBottom: 20 }]}
                >
                  IN KIND SUPPORT/PREVIOIUS SPONSORSHIPS
                </Text>
                <Text style={styles.text_body}>
