...
function Page(props) {
	...
	const isContentExist = !props.content;

	useEffect(() => {
		getContent({ type: "content", uid: "donate" })
			.then((_content) => {
					...
					<View style={[styles.section]}>
						<View style={styles.content}>
							...
							<Part title="Transparency" imgSrc={isWeb ? { uri: "/images/search.png" } : require("../public/images/search.png")}>
								Transparency is fundamental to our organization's purpose and success. It is important to us that our donors know exactly how we work to create
								change within their communities. We do not charge the businesses to be listed on Spicy Green Book. We are grateful for the support of our
								dedicated donors. Our work would not be possible without you. Your contributions will go to the upkeep of the site, and addition of new
							...
							>
								...
								monthly support with the support of other sponsors — creating a "ripple effect" of positive change and funding long term community development.
...
const styles = StyleSheet.create({
	...getStyles("text_header2, text_header3, section, content, button_green, button_green_text, text_body"),
});
